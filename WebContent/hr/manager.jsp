  ...
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div >
       ...
       <!-- 여기에 넣기! -->
       <title>관리자 페이지 회원 포인트 정보 갱신</title>
...
<form action="/hr/Point.do" method="post">
	...
	<%for(MemberVO member:memberList){ %>
		<li><a href="/hr/Point.do?cmd=info&phoneNumber=<%=member.getPhoneNumber()%>"><%=member.getName() %>(<%=member.getPhoneNumber()%>) 님의 포인트 정보 갱신</a></li>
	<%}%>
